...
declare class DOMException extends Error {
  ...
  /**
   * The **`message`** read-only property of the a message or description associated with the
   * given error name.
   *
  ...
  /**
   * The **`code`** read-only property of the DOMException interface returns one of the legacy
...
interface Console {
  ...
  /**
   * The **`console.timeEnd()`** static method stops a timer that was previously started by
   * calling console/time_static.
   *
   * [MDN Reference](https://developer.mozilla.org/docs/Web/API/console/timeEnd_static)
   */
  timeEnd(label?: string): void;
  /**
   * The **`console.timeLog()`** static method logs the current value of a timer that was
   * previously started by calling console/time_static.
   *
...
declare class Event {
  ...
  /**
   * The read-only **`composed`** property of the or not the event will propagate across the
  ...
  /**
   * The **`bubbles`** read-only property of the Event interface indicates whether the event
   * bubbles up through the DOM tree or not.
   *
   ...
   * (including via user actions and programmatic methods such as HTMLElement.focus()), and
   * `false` when the event was dispatched via The only exception is the `click` event, which
   * initializes the `isTrusted` property to `false` in user agents.
   *
   ...
   * event does not get explicitly handled, its default action should not be taken as it normally
   * would be.
   *
...
declare abstract class AbortSignal extends EventTarget {
  ...
  get aborted(): boolean;
  /**
   * The **`reason`** read-only property returns a JavaScript value that indicates the abort
   * reason.
   *
...
declare class Blob {
  ...
  /**
   * The **`size`** read-only property of the Blob interface returns the size of the Blob or File
   * in bytes.
   *
...
declare class File extends Blob {
  ...
  get name(): string;
  /**
   * The **`lastModified`** read-only property of the File interface provides the last modified
   * date of the file as the number of milliseconds since the Unix epoch (January 1, 1970 at
   * midnight).
   *
...
declare abstract class SubtleCrypto {
  ...
  /**
   * The **`digest()`** method of the SubtleCrypto interface generates a _digest_ of the given
   * data, using the specified hash function.
   *
  ...
  /**
   * The **`generateKey()`** method of the SubtleCrypto interface is used to generate a new key
   * (for symmetric algorithms) or key pair (for public-key algorithms).
   *
  ...
  /**
   * The **`importKey()`** method of the SubtleCrypto interface imports a key: that is, it takes
   * as input a key in an external, portable format and gives you a CryptoKey object that you can
   * use in the Web Crypto API.
   *
  ...
  /**
   * The **`exportKey()`** method of the SubtleCrypto interface exports a key: that is, it takes
   * as input a CryptoKey object and gives you the key in an external, portable format.
   *
...
declare abstract class CryptoKey {
  ...
  /**
   * The read-only **`algorithm`** property of the CryptoKey interface returns an object
   * describing the algorithm for which this key can be used, and any associated extra
   * parameters.
   *
  ...
  /**
   * The read-only **`usages`** property of the CryptoKey interface indicates what can be done
   * with the key.
   *
...
declare class TextDecoder {
  ...
  /**
   * The **`TextDecoder.decode()`** method returns a string containing text decoded from the
...
declare class TextEncoder {
   ...
   * Uint8Array to put resulting UTF-8 encoded text into, and returns a dictionary object
   * indicating the progress of the encoding.
   *
...
declare class ErrorEvent extends Event {
  ...
  get filename(): string;
  /**
   * The **`message`** read-only property of the ErrorEvent interface returns a string containing
  ...
  get colno(): number;
  /**
   * The **`error`** read-only property of the ErrorEvent interface returns a JavaScript value,
   * such as an Error or DOMException, representing the error associated with this event.
   *
...
declare class MessageEvent extends Event {
  ...
  /**
   * The **`data`** read-only property of the The data sent by the message emitter; this can be
   * any data type, depending on what originated this event.
   *
...
declare class FormData {
  ...
  /**
   * The **`has()`** method of the FormData interface returns whether a `FormData` object contains
   * a certain key.
   *
  ...
  /**
   * The **`set()`** method of the FormData interface sets a new value for an existing key inside
   * a `FormData` object, or adds the key/value if it does not already exist.
   *
...
declare class Headers {
  ...
  /**
   * The **`getSetCookie()`** method of the Headers interface returns an array containing the
   * values of all Set-Cookie headers associated with a response.
   *
  ...
  set(name: string, value: string): void;
  /**
   * The **`append()`** method of the Headers interface appends a new value onto an existing
...
interface Response extends Body {
  ...
  clone(): Response;
  /**
   * The **`status`** read-only property of the Response interface contains the HTTP status codes
   * of the response.
   *
  ...
  ok: boolean;
  /**
   * The **`redirected`** read-only property of the Response interface indicates whether or not
   * the response is the result of a request you made which was redirected.
   *
...
interface Request<CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>> extends Body {
  ...
  /**
   * The **`method`** read-only property of the `POST`, etc.) A String indicating the method of
   * the request.
   *
...
interface StreamPipeOptions {
  ...
  /**
   * Pipes this readable stream to a given writable stream destination. The way in which the
   * piping process behaves under various error conditions can be customized with a number of
   * passed options. It returns a promise that fulfills when the piping process completes
   ...
   *
   * An error in this source readable stream will abort destination, unless preventAbort is
   * truthy. The returned promise will be rejected with the source's error, or with any error that
   * occurs during aborting the destination.
   *
   ...
   * truthy. The returned promise will be fulfilled once this process completes, unless an error
   * is encountered while closing the destination, in which case it will be rejected with that
   * error.
   *
   ...
   *
   * The signal option can be set to an AbortSignal to allow aborting an ongoing pipe operation
   * via the corresponding AbortController. In this case, this source readable stream will be
   * canceled, and destination aborted, unless the respective options preventCancel or
...
interface ReadableStream<R = any> {
  /**
   * The **`locked`** read-only property of the ReadableStream interface returns whether or not
   * the readable stream is locked to a reader.
   *
   * [MDN Reference](https://developer.mozilla.org/docs/Web/API/ReadableStream/locked)
   */
  get locked(): boolean;
  /**
   * The **`cancel()`** method of the ReadableStream interface returns a Promise that resolves
   ...
   * to a given WritableStream and returns a Promise that fulfills when the piping process
...
declare class ReadableStreamBYOBReader {
  ...
  /**
   * The **`releaseLock()`** method of the ReadableStreamBYOBReader interface releases the
   * reader's lock on the stream.
   *
   * [MDN
...
interface ReadableStreamGetReaderOptions {
   ...
   * directly read individual chunks from the stream via its read() method, into
   * developer-supplied buffers, allowing more precise control over allocation.
   */
  mode: "byob";
}
/**
...
declare abstract class ReadableStreamBYOBRequest {
  ...
  /**
   * The **`respond()`** method of the ReadableStreamBYOBRequest interface is used to signal to
   * the associated readable byte stream that the specified number of bytes were written into the
...
declare abstract class ReadableStreamDefaultController<R = any> {
  ...
  /**
   * The **`close()`** method of the ReadableStreamDefaultController interface closes the
   * associated stream.
   *
   * [MDN
...
declare abstract class ReadableByteStreamController {
  /**
   * The **`byobRequest`** read-only property of the ReadableByteStreamController interface
   * returns the current BYOB request, or `null` if there are no pending requests.
   *
   * [MDN
  ...
  /**
   * The **`desiredSize`** read-only property of the ReadableByteStreamController interface
   * returns the number of bytes required to fill the stream's internal queue to its 'desired
   * size'.
   *
   * [MDN
   ...
   * chunk on the associated readable byte stream (the chunk is copied into the stream's internal
   * queues).
   *
   * [MDN
...
declare abstract class TransformStreamDefaultController<O = any> {
  ...
  get desiredSize(): number | null;
  /**
   * The **`enqueue()`** method of the TransformStreamDefaultController interface enqueues the
   * given chunk in the readable side of the stream.
   *
   * [MDN
  ...
  /**
   * The **`error()`** method of the TransformStreamDefaultController interface errors both sides
   * of the stream.
   *
   * [MDN
...
interface ReadableWritablePair<R = any, W = any> {
  ...
  /**
   * Provides a convenient, chainable way of piping this readable stream through a transform
   * stream (or any other { writable, readable } pair). It simply pipes the stream into the
   * writable side of the supplied pair, and returns the readable side for further use.
   *
   * Piping a stream will lock it for the duration of the pipe, preventing any other consumer from
   * acquiring a reader.
   */
...
declare class WritableStream<W = any> {
  ...
  get locked(): boolean;
  /**
   * The **`abort()`** method of the WritableStream interface aborts the stream, signaling that
   * the producer can no longer successfully write to the stream and it is to be immediately moved
   * to an error state, with any queued writes discarded.
   *
...
declare class WritableStreamDefaultWriter<W = any> {
  ...
  /**
   * The **`closed`** read-only property of the the stream errors or the writer's lock is
   * released.
   *
   * [MDN
  ...
  get desiredSize(): number | null;
  /**
   * The **`abort()`** method of the the producer can no longer successfully write to the stream
...
declare class URL {
  ...
  /**
   * The **`protocol`** property of the URL interface is a string containing the protocol or
   * scheme of the URL, including the final `':'`.
   *
  ...
  /**
   * The **`username`** property of the URL interface is a string containing the username
  ...
  /**
   * The **`password`** property of the URL interface is a string containing the password
   * component of the URL.
   *
  ...
  /**
   * The **`hostname`** property of the URL interface is a string containing either the domain
   * name or IP address of the URL.
   *
  ...
  /**
   * The **`port`** property of the URL interface is a string containing the port number of the
   * URL.
   *
  ...
  /**
   * The **`toJSON()`** method of the URL interface returns a string containing a serialized
   * version of the URL, although in practice it seems to have the same effect as `js-nolint
   * toJSON() ` None.
   *
  ...
  /**
   * The **`revokeObjectURL()`** static method of the URL interface releases an existing object
   * URL which was previously created by calling Call this method when you've finished using an
   * object URL to let the browser know not to keep the reference to the file any longer.
   *
...
declare class URLSearchParams {
  ...
  getAll(name: string): string[];
  /**
   * The **`has()`** method of the URLSearchParams interface returns a boolean value that
   * indicates whether the specified parameter is in the search parameters.
   *
...
interface WebSocket extends EventTarget<WebSocketEventMap> {
   ...
   * over the WebSocket connection, increasing the value of `bufferedAmount` by the number of
   * bytes needed to contain the data.
   *
  ...
  url: string | null;
  /**
   * The **`WebSocket.protocol`** read-only property returns the name of the sub-protocol the
   * server selected; this will be one of the strings specified in the `protocols` parameter when
   * creating the WebSocket object, or the empty string if no connection is established.
   *
...
interface WebSocketAcceptOptions {
   ...
   * send a reciprocal Close frame, leaving the connection in a half-open state. This is useful
   * for proxying scenarios where you need to coordinate closing both sides independently.
   * Defaults to `false` when the `no_web_socket_half_open_by_default` compatibility flag is
   * enabled.
   */
...
declare abstract class MessagePort extends EventTarget {
  ...
  /**
   * The **`close()`** method of the MessagePort interface disconnects the port, so it is no
   * longer active.
   *
  ...
  close(): void;
  /**
   * The **`start()`** method of the MessagePort interface starts the sending of messages queued
   * on the port.
   *
...
declare class MessageChannel {
  constructor();
  /**
   * The **`port1`** read-only property of the the port attached to the context that originated
   * the channel.
   *
  ...
  /**
   * The **`port2`** read-only property of the the port attached to the context at the other end
...
declare abstract class AgentMemoryProfile {
   ...
   *
   * Returns a paginated, filterable view of stored memories. Superseded versions are excluded.
   * Use the returned `cursor` (when present) to fetch the next page.
   *
...
declare abstract class AgentMemoryNamespace {
  ...
  /**
   * Soft-delete a profile and schedule deferred purge. Marks all memories and messages as
   * deleted.
   *
...
declare abstract class AiSearchNamespace {
  ...
  /**
   * Generate chat completions across multiple instances within the bound namespace. Fans out to
   * the specified instance_ids, merges context, and generates a response.
   *
...
type Ai_Cf_Baai_Bge_Base_En_V1_5_Input =
  | {
       ...
       * embeddings on larger inputs - however, embeddings created with cls pooling are not compatible
       * with embeddings generated with mean pooling. The default pooling method is `mean` in order
       * for this to not be a breaking change, but we highly suggest using the new `cls` pooling for
       * better accuracy.
       */
      pooling?: "mean" | "cls";
    }
...
interface Ai_Cf_Openai_Whisper_Large_V3_Turbo_Output {
  transcription_info?: {
    ...
    language?: string;
    /**
     * The confidence level or probability of the detected language being accurate, represented
    ...
    duration?: number;
    /**
     * The duration of the audio after applying Voice Activity Detection (VAD) to remove silent
     * or irrelevant sections, in seconds.
     */
  ...
  segments?: {
    ...
    text?: string;
    /**
     * The temperature used in the decoding process, controlling randomness in predictions.
     * Lower values result in more deterministic outputs.
     */
    temperature?: number;
    /**
    ...
    avg_logprob?: number;
    /**
     * The compression ratio of the input to the output, measuring how much the text was
     * compressed during the transcription process.
     */
    compression_ratio?: number;
    /**
     * The probability that the segment contains no speech, represented as a decimal between 0
     * and 1.
     */
...
interface Ai_Cf_Baai_Bge_M3_Input_QueryAnd_Contexts {
  ...
  query?: string;
  /**
   * List of provided contexts. Note that the index in this array is important, as the response
   * will refer to it.
   */
  contexts: {
  ...
  /**
   * When provided with too long context should the model error out or truncate the context to
   * fit?
   */
...
interface Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Async_Batch {
  requests?: {
    /**
     * User-supplied reference. This field will be present in the response as well it can be
     * used to reference the request and response. It's NOT validated to be unique.
     */
    ...
    /**
     * Adjusts the creativity of the AI's responses by controlling how many possible words it
     * considers. Lower values make outputs more predictable; higher values allow for more
     * varied and creative responses.
     */
    top_p?: number;
    /** Random seed for reproducibility of the generation. */
    seed?: number;
...
interface Ai_Cf_Mistralai_Mistral_Small_3_1_24B_Instruct_Messages {
  ...
  messages: {
    ...
    role?: string;
    /**
     * The tool call id. Must be supplied for tool calls for Mistral-3. If you don't know what
     * to put here you can fall back to 000000001
     */
    tool_call_id?: string;
    content?:
      | string
...
interface Ai_Cf_Deepgram_Nova_3_Input {
  ...
  /**
   * Sets how the model will interpret strings submitted to the custom_topic param. When strict,
   * the model will only return topics submitted using the custom_topic param. When extended, the
   * model will return its own detected topics in addition to those submitted using the
   * custom_topic param.
   */
   ...
   * the model will only return intents submitted using the custom_intent param. When extended,
   * the model will return its own detected intents in addition those submitted using the
   * custom_intents param
   */
  ...
  /**
   * Indicates how long model will wait to detect whether a speaker has finished speaking or
   * pauses for a significant period of time. When set to a value, the streaming endpoint
   * immediately finalizes the transcription for the processed time range and returns the
   * transcript with a speech_final parameter set to true. Can also be set to false to disable
   * endpointing
   */
  endpointing?: string;
  /**
...
interface RequestInitCfProperties extends Record<string, unknown> {
   ...
   * If a request has the same cache key as some previous request, then we can serve the same
   * cached response for both. (e.g. 'some-key')
   *
   * Only available for Enterprise customers.
   */
  cacheKey?: string;
  /**
   * This allows you to append additional Cache-Tag response headers to the origin response
   * without modifications to the origin server. This will allow for greater control over the
   * Purge by Cache Tag feature utilizing changes only in the Workers process.
   *
   * Only available for Enterprise customers.
   */
  cacheTags?: string[];
   ...
   *
   * Cannot be used together with `cacheTtl` or the `cache` request option
   * (`no-store`/`no-cache`), as these are mutually exclusive cache control mechanisms. Setting
  ...
  /**
   * Whether to enable Cache Deception Armor, which protects against web cache deception attacks
   * by verifying the Content-Type matches the URL extension.
   */
   ...
   * allowed, so to resolve to a host under a different domain or a DNS only domain first declare
   * a CNAME record within your own zone’s DNS mapping to the external hostname, set proxy on
...
interface BasicImageTransformations {
  ...
  height?: number;
  /**
   * When cropping with fit: "cover", this defines the side or point that should be left
   * uncropped. The value is either a string "left", "right", "top", "bottom", "auto", or "center"
   * (the default), or an object {x, y} containing focal point coordinates in the original image
   ...
   * side to preserve as much as possible around a point at 20% of the height of the source
   * image.
   */
  gravity?:
    | "face"
   ...
   * scale-down: Similar to contain, but the image is never enlarged. If the image is larger than
   * given width or height, it will be resized. Otherwise its original size will be kept. -
   * scale-up: Similar to contain, but the image is never shrunk. If the image is smaller than the
   * given width or height, it will be resized. Otherwise its original size will be kept. -
   * contain: Resizes to maximum size that fits within the given width and height. If only a
   * single dimension is given (e.g. only width), the image will be shrunk or enlarged to exactly
   * match that dimension. Aspect ratio is always preserved. - cover: Resizes (shrinks or
   * enlarges) to fill the entire area of width and height. If the image has an aspect ratio
   * different from the ratio of width and height, it will be cropped to fit. - crop: The image
   * will be shrunk and cropped to fit within the area specified by width and height. The image
   * will not be enlarged. For images smaller than the given dimensions it's the same as
   * scale-down. For images larger than the given dimensions, it's the same as cover. See also
   * trim. - pad: Resizes to the maximum size that fits within the given width and height, and
   * then fills the remaining area with a background color (white by default). Use of this mode is
   * not recommended, as the same effect can be more efficiently achieved with the contain mode
   * and the CSS object-fit: contain property. - squeeze: Stretches and deforms to the width and
   * height given, even if it breaks aspect ratio
   */
   ...
   * rotation.
   *
   * It can be used as: - left, top, right, bottom - it will specify the number of pixels to cut
   * off each side - width, height - the width/height you'd like to end up with - can be used in
   * combination with the properties above - border - this will automatically trim the
   * surroundings of an image based on it's color. It consists of three properties: - color: rgb
   * or hex representation of the color you wish to trim (todo: verify the rgba bit) - tolerance:
  ...
  /**
   * Background color to add underneath the image. Applies only to images with transparency (such
   * as PNG). Accepts any CSS color (#RRGGBB, rgba(…), hsl(…), etc.)
   */
  background?: string;
  /**
   * Flips the images horizontally, vertically, or both. Flipping is applied before rotation, so
   * if you apply flip=h,rotate=90 then the image will be flipped horizontally, then rotated by 90
   * degrees.
   */
  flip?: "h" | "v" | "hv";
  /**
   * Number of degrees (90, 180, 270) to rotate the image by. width and height options refer to
   * axes after rotation.
   */
   ...
   * into account, and can be specified either using a single width property, or individually for
   * each side.
   */
  border?:
    | {
   ...
   * `fit=scale-down` or when the target dimensions are smaller than the source. - interpolate:
   * Uses bicubic interpolation, which may reduce image quality. This is the default behavior when
...
interface RequestInitCfPropertiesImageDraw extends BasicImageTransformations {
   ...
   * 0 aligns exactly to the edge. For example, left: 10 positions left side of the overlay 10
   * pixels from the left edge of the image it's drawn over. bottom: 0 aligns bottom of the
   * overlay with bottom of the background image.
   *
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
   ...
   * worse, but load faster. The default is 85. It applies only to JPEG and WebP images. It
   * doesn’t have any effect on PNG.
   */
  quality?: number | "low" | "medium-low" | "medium-high" | "high";
  /**
   * Output format to generate. It can be: - avif: generate images in AVIF format. - webp:
   * generate images in Google WebP format. Set quality to 100 to get the WebP-lossless format. -
   * json: instead of generating an image, outputs information about the image, in JSON format.
   * The JSON object will contain image size (before and after resizing), source image’s MIME
   * type, file size, etc. - jpeg: generate images in JPEG format. - png: generate images in PNG
   * format.
   */
   ...
   * processing arbitrary user content, because large GIF animations can weigh tens or even
   * hundreds of megabytes. It is also useful to set anim:false when using format:"json" to get
   * the response quicker without the number of frames.
   */
  anim?: boolean;
  /**
   ...
   * option. Note that if the Polish feature is enabled, all metadata may have been removed
   * already and this option may have no effect. - keep: Preserve most of EXIF metadata, including
   * GPS location if there's any. - copyright: Only keep the copyright tag, and discard everything
   * else. This is the default behavior for JPEG files. - none: Discard all invisible EXIF
   * metadata. Currently WebP and PNG output formats always discard metadata.
   */
  ...
  /**
   * Slightly reduces latency on a cache miss by selecting a quickest-to-compress file format, at
   * a cost of increased file size and lower image quality. It will usually override the format
   * option and choose JPEG over WebP or AVIF. We do not recommend using this option, except in
   * unusual circumstances like resizing uncacheable dynamically-generated images.
   */
  compression?: "fast";
}
...
interface IncomingRequestCfPropertiesBase extends Record<string, unknown> {
   ...
   * [`FINISHED`](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.9) messages from this
   * request's TLS handshake.
   *
...
interface IncomingRequestCfPropertiesBotManagementBase {
   ...
   * extensions](https://developers.cloudflare.com/bots/reference/static-resources/) for many
...
interface IncomingRequestCfPropertiesBotManagementEnterprise extends IncomingRequestCfPropertiesBotManagement {
  ...
  botManagement: IncomingRequestCfPropertiesBotManagementBase & {
    /**
     * A [JA3 Fingerprint](https://developers.cloudflare.com/bots/concepts/ja3-fingerprint/) to
     * help profile specific SSL/TLS clients across different destination IPs, Ports, and X509
     * certificates.
     */
    ja3Hash: string;
  };
...
interface IncomingRequestCfPropertiesCloudflareForSaaSEnterprise<HostMetadata> {
   ...
   *
   * This field is only present if you have Cloudflare for SaaS enabled on your account and you
   * have followed the [required steps to enable
...
interface IncomingRequestCfPropertiesCloudflareAccessOrApiShield {
   ...
   *
   * The property `certPresented` will be set to `"1"` when the object is populated (i.e. the
...
interface IncomingRequestCfPropertiesExportedAuthenticatorMetadata {
  /**
   * The client's [`HELLO` message](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.1.2),
  ...
  /**
   * The server's [`HELLO` message](https://www.rfc-editor.org/rfc/rfc5246#section-7.4.1.2),
   * encoded in hexadecimal
   *
   * @example
   *   "44372ba35fa1270921d318f34c12f155dc87b682cf36a790cfaa3ba8737a1b5d";
...
interface IncomingRequestCfPropertiesTLSClientAuth {
   ...
   * format as a comma-separated list. Empty if no intermediates were sent or if the chain
   * exceeded 16 KB (see {@link certChainRFC9440TooLarge}).
   *
...
interface D1Meta {
  ...
  /**
   * Number of total attempts to execute the query, due to automatic retries. Note: All other
   * fields in the response like `timings` only apply to the last attempt.
   */
...
declare abstract class D1Database {
  ...
  /**
   * Creates a new D1 Session anchored at the given constraint or the bookmark. All queries
   * executed using the created session will have sequential consistency, meaning that all writes
   * done through the session will be visible in subsequent reads.
   *
...
interface ForwardableEmailMessage extends EmailMessage {
  ...
  /**
   * Reply to the sender of this email message with a message built from the given fields.
...
interface Hyperdrive {
   ...
   *
   * Calling this method returns an identical socket to if you call `connect("host:port")` using
   * the `host` and `port` fields from this object. Pick whichever approach works better with your
   * preferred DB client library.
   *
   * Note that this socket is not yet authenticated -- it's expected that your code (or
   * preferably, the client library of your choice) will authenticate using the information in
   * this class's readonly fields.
   */
  connect(): Socket;
  /**
...
declare module "cloudflare:pipelines" {
  ...
  > {
    ...
    /**
     * Run receives an array of PipelineRecord which can be transformed and returned to the
     * pipeline
     *
     * @param records Incoming records from the pipeline to be transformed
     * @param metadata Information about the specific pipeline calling the transformation
     *   entrypoint
...
type StreamUrlUploadParams = {
  ...
  meta?: Record<string, string>;
  /**
   * Indicates whether the video can be a accessed using the id. When set to `true`, a signed
   * token must be generated with a signing key to view the video.
   */
  requireSignedURLs?: boolean;
  /**
   * Indicates the date and time at which the video will be deleted. Omit the field to indicate no
   * change, or include with a `null` value to remove an existing scheduled deletion. If
   * specified, must be at least 30 days from upload time.
   */
  scheduledDeletion?: string | null;
  /**
...
interface StreamScopedCaptions {
  /**
   * Uploads the caption or subtitle file to the endpoint for a specific BCP47 language. One
   * caption or subtitle file per language is allowed.
   *
...
type StreamWatermark = {
  ...
  created: string;
  /**
   * The source URL for a downloaded image. If the watermark profile was created via direct
  ...
  opacity: number;
  /**
   * The whitespace between the adjacent edges (determined by position) of the video and the
   * image. `0.0` indicates no padding, and `1.0` indicates a fully padded video width or length,
...
declare module "cloudflare:workflows" {
  /**
   * NonRetryableError allows for a user to throw a fatal error that makes a Workflow instance
   * fail immediately without triggering a retry
   */
...
declare abstract class Workflow<PARAMS = unknown> {
   ...
   * error will be thrown. `createBatch` is limited at 100 instances at a time or when the RPC
   * limit for the batch (1MiB) is reached.
   *
...
interface WorkflowInstanceCreateOptions<PARAMS = unknown> {
  ...
  params?: PARAMS;
  /**
   * The retention policy for Workflow instance. Defaults to the maximum retention period
   * available for the owner's account.
   */
  retention?: {
...
interface WorkflowInstanceRestartOptions {
  ...
  from?: {
    ...
    name: string;
    /**
     * 1-indexed occurrence of this step name. Use when the same step name appears multiple
     * times (e.g. in a loop).
     *
     * @default 1
     */
